# (Odyssey Course) Growing your GraphQL API with Java & DGS

Welcome to the starter code for **Growing your GraphQL API with Java & DGS**. You can find the [course lessons and instructions](https://apollographql.com/tutorials/growing-graphql-api-lab) on Odyssey, [Apollo](https://apollographql.com)'s learning platform.
